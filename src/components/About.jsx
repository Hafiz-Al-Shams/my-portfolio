                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="w-full sm:w-3/4 md:w-2/3 lg:w-2/3">
                        ...
                        <p className="text-base sm:text-lg text-gray-300 leading-normal sm:leading-relaxed"> {/* Adjusted text size & line height */}
                            👋 Hey, I’m <span className="text-blue-400 font-semibold">Hafiz</span>! I’m a passionate <strong>Full Stack Web Developer</strong> dedicated to crafting beautiful and efficient digital experiences.
